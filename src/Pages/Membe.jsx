            ...
            .map((wrestler) => (
              <div key={wrestler.id} className="relative">
                ...
                <div className="relative flex flex-col px-5 py-3">
                  <div
                    className={`order-2 duration-700 ease-in-out md:right-28 md:order-1  md:ml-[15rem] md:flex md:justify-center  ${stats ? "lgg:ml-[14rem]" : "lgg:ml-[-410px]"}`}
                  >
                    <img
                      src={Smackdown}
                      alt="Raw logo"
                ...
                <div
                  className={`gap-5 duration-700 ease-in-out xxs:hidden md:ml-[14rem] md:mt-1 md:flex md:justify-center ${stats ? "" : "lgg:ml-[-400px]"}`}
                >
                  <FaFacebookF
                    size={25}
                ...
                <div
                  className={`group absolute right-0 z-[200] w-[700px] bg-[#232828] text-xl text-white transition-all duration-500 ease-in-out xxs:top-[-40px] xxs:w-full lgg:w-[80%] ${stats ? " invisible absolute indent-[100px] opacity-0 duration-700 md:indent-[300px]" : ""}`}
                >
                  <div className="py-7">
